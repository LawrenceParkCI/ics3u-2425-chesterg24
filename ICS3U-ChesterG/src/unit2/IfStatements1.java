...
public class IfStatements1 {
	  public static void main(String[] args) {
	    ...
	    //What prints out? Why?
	    //In part one, nothing is printed because 10 is not greater than 30
	    ...
	    //What prints out? Why?
	    //In part 2, "XQCL" is printed because the first condition is not satisfied therefore the else statement is executed
	    ...
	    //What prints out? Why?
	    //In part 3, "sykSHY" is printed. This is because the first if statement is not satisfied and the next else if conditions are satisfied/ 
	    ...
	    //The difference is the first part has an if, else if, and else statement.
	    //The second part has three if statement which allows more true conditions to be executed and printed
